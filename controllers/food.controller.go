...
func GetFood() gin.HandlerFunc {
	return func (c *gin.Context){
		...
		defer cancel()
		if err != nil{
			c.JSON(http.StatusInternalServerError, gin.H{"erorr" : "Error occured while fetching the particular food item"})
		}
...
func CreateFood() gin.HandlerFunc{
	return func (c *gin.Context){
		...
		defer cancel()
		if err != nil{
			msg := fmt.Sprintf("Menu couldn't be found")
...
func UpdateFood() gin.HandlerFunc{
	return func(c *gin.Context){
		...
		if food.Menu_id != nil{
			...
			defer cancel()
			if err != nil{
				msg := fmt.Sprintf("Menu could not be found! ")
				c.JSON(http.StatusInternalServerError, gin.H{"error": msg})
				return 
			}
		...
		if err != nil {
			msg := fmt.Sprint("Food item has failed")
			c.JSON(http.StatusInternalServerError, gin.H{"error": msg})
			return
		}
